...
const CATS = {
  ...
  roblox: {
    ...
    cmds: [
      ...
      { name: 'tag',        desc: 'Apply a Roblox group tag to a user.',                    aliases: ['t'],                        parameters: 'username tag',        info: 'Tags: 164, lurk tag, AMOR TAG, KITTY TAG, YingYang', usage: '.tag <username> <tag>', example: '.tag builderman lurk tag' },
